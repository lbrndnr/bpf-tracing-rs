...
#define BPF_LOG_LEVEL_TRACE 5
        ...
        #define bpf_start_error_span(fmt, ...) bpf_error("SOS " fmt, ##__VA_ARGS__)
        #define bpf_end_span(fmt, ...) bpf_printk("EOS " fmt, ##__VA_ARGS__)
        ...
        #define bpf_start_debug_span(...) (0)
        #define bpf_start_info_span(...) (0)
        #define bpf_start_warn_span(fmt, ...) bpf_warn("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_error_span(fmt, ...) bpf_error("SOS " fmt, ##__VA_ARGS__)
        #define bpf_end_span(fmt, ...) bpf_printk("EOS " fmt, ##__VA_ARGS__)
        ...
        #define bpf_start_trace_span(...) (0)
        #define bpf_start_debug_span(...) (0)
        #define bpf_start_info_span(fmt, ...) bpf_info("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_warn_span(fmt, ...) bpf_warn("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_error_span(fmt, ...) bpf_error("SOS " fmt, ##__VA_ARGS__)
        #define bpf_end_span(fmt, ...) bpf_printk("EOS " fmt, ##__VA_ARGS__)
        ...
        #define bpf_start_trace_span(...) (0)
        #define bpf_start_debug_span(fmt, ...) bpf_debug("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_info_span(fmt, ...) bpf_info("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_warn_span(fmt, ...) bpf_warn("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_error_span(fmt, ...) bpf_error("SOS " fmt, ##__VA_ARGS__)
        #define bpf_end_span(fmt, ...) bpf_printk("EOS " fmt, ##__VA_ARGS__)
        ...
        #define bpf_start_trace_span(fmt, ...) bpf_trace("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_debug_span(fmt, ...) bpf_debug("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_info_span(fmt, ...) bpf_info("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_warn_span(fmt, ...) bpf_warn("SOS " fmt, ##__VA_ARGS__)
        #define bpf_start_error_span(fmt, ...) bpf_error("SOS " fmt, ##__VA_ARGS__)
